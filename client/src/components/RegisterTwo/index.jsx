          ...
          <div className={`${Style.formComplete} row`}>
            ...
            <div className={`${Style.formRegister} col-12`}>
              <div className={Style.titleForm}>
                ...
                <h5 className={`${Style.descriptionReg}`}>
              ...
              <div className={`${Style.data}`}>
                <div className={`row`}>
                  ...
                  <input
                    autoFocus
                    className={`mail col-4 col-sm-3 col-md-3 col-lg-3 text-center`}
                    type="text"
                    name="rut1"
                    id="rut1"
                  ...
                  &nbsp;-&nbsp;
                  <input
                    className={`mail col-1 col-sm-1 col-md-1 col-lg-1 text-center`}
                    type="text"
                    name="rut2"
                    id="rut2"
                    onChange={(e) => verifyRut(e)}
                ...
                <div className={`row`}>
                  ...
                  <input
                    className={`mail col-11 col-sm-8 col-md-8 col-lg-9`}
                    type="text"
                    name="mail"
                    value={form.mail}
                ...
                <div className={`row`}>
                  <h4
                    className={`${Style.repeatMailLabel} col-sm-3 col-md-3 col-lg-2`}
                  >
                    Repetir Mail (*)
                  </h4>
                  <input
                    className={`${Style.repeatMail} repeatMail col-11 col-sm-8 col-md-8 col-lg-9`}
                    type="text"
                    disabled
                    name="repeatMail"
                  ...
                  {!error.mail && !email.repeat && form.repeatMail ? (
                    <div className={`row`}>
                      <h5 className={`${Style.alertTexts2} col-9`}>
                        Debe repetir exactamente el correo colocado
                      </h5>
                    </div>
                  ) : null}
                </div>
                <div className={`row`}>
                  <h4
                    className={`${Style.admLabel} col-sm-3 col-md-3 col-lg-2`}
                  >
                    Nombre (*)
                  </h4>
                  <input
                    className={`${Style.inputLabel} col-11 col-sm-8 col-md-8 col-lg-9`}
                    type="text"
                    name="admin"
                    value={form.admin}
                ...
                <div className={`row`}>
                  <h4 className={`col-11 col-sm-3 col-md-3 col-lg-2`}>
                    Dirección (*)
                  </h4>
                  <input
                    className={`${Style.inputDir} col-11 col-sm-8 col-md-8 col-lg-9`}
                    type="text"
                    name="direccion"
                ...
                <div className={`row`}>
                  <h4 className={`${Style.fechaNac} col-11 col-md-5 col-lg-4`}>
                    Fecha de Nacimiento (*)
                  </h4>
                  <form
                    className={`${classes.container} ${Style.inputFecha} col-11 col-md-6 col-lg-7`}
                    noValidate
                  >
                    <TextField
                      id="date"
                ...
                <div className={`${Style.cel} row`}>
                  ...
                  <input
                    className={`${Style.celInp1} col-11 col-sm-8 col-md-3 col-lg-3 mt-1`}
                    type="text"
                    name="cel1"
                    value={form.cel1}
                  ...
                  />
                  <h4
                    className={`${Style.cel2} col-11 col-sm-3 col-md-2 col-lg-2 text-md-center text-lg-center`}
                  >
                    Celular2
                  </h4>
                  <input
                    className={`${Style.celInp2} col-11 col-sm-8 col-md-3 col-lg-4 mt-1`}
                    type="text"
                    name="cel2"
                    value={form.cel2}
                    onChange={(e) => verifyCel(e)}
                ...
                <div className={`row`}>
                  <h4 className={`col-sm-5 col-md-5 col-lg-3`}>
                    Nro Cuenta Bancaria (*)
                  </h4>
                  <input
                    className={`mail col-11 col-sm-6 col-md-6 col-lg-8`}
                    type="text"
                    name="cuenta"
                    value={form.cuenta}
                    onChange={(e) => verifyCel(e)}
                ...
                <div className={`row`}>
                  <h4 className={`col-sm-4 col-md-4 col-lg-2`}>
                    Tipo Cuenta (*)
                  </h4>
                  <select
                    className={`mail col-11 col-sm-7 col-md-7 col-lg-9`}
                    name="tipo_cuenta"
            ...
            <div className={Style.containerSave}>
              <h5
                className={`${
                  alldata.ready && "d-none"
                } text-center formComplete`}
              ></h5>
              <div
                className={`${Style.buttons} row d-flex justify-content-center`}
              >
