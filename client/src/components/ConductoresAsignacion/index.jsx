...
export default function ConductoresAsignacion() {
  ...
  const driverAssign = async (e, idDriver, idCar) => {
    e.preventDefault();
    // alert("Asignando car " + idDriver + idCar);
                        ...
                        <tr key={index}>
                          ...
                          >
                            <a
                              href=""
                              onClick={(e) =>
                                driverAssign(e, element.id, params.id)
                              }
                            >
                              <TiTickOutline className={Style.edit} />
                            </a>
                            {/* <a
                              href=""
