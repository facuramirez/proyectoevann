...
export default function PendientesAsociados({alto}) {
    ...
    useEffect(()=>{
        axios.get(`${process.env.REACT_APP_BACKEND}/owners?is_approved=false`)
        .then(response => {
            ...
            <div className={`${Style.containerPendientes} row containerVehiculos`}>
                <div className={`${Style.fondo} row m-0`}>
                    <div className={`${Style.title} col-12 mt-2`}>
                        <h3>Pendientes de Aprobación - Cuentas</h3>
                    </div>
                    {cars.length > 0 ?
