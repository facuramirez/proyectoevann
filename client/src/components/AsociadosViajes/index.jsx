...
import Style from './AsociadosViajes.module.css';
...
export default function AsociadosViajes({alto}) {
                            ...
                            <tbody className={`${Style.tableB}`}>
                                ...
                                <tr key={index}>
                                    ...
                                    <td className={`${Style.buttons} d-flex justify-content-evenly`}>
                                        <Link to="/back_office_administracion/pendientes_aprobacion/viajes/detalles"><ImEye className={Style.details}/></Link>
                                    </td>
                                </tr>
                                )
