        ...
        <div className={`${Style.fondo} row m-0`}>
          ...
          <div className={`${Style.formCar} col-12 mt-4`}>
            <section className={`row justify-content-center m-auto`}>
              <div className={`col-12`}>
                <div className={`row`}>
                  <label className={`${Style.asterisk} col-8`}>
              ...
              <div className={`col-6 mt-2`}>
                <div className={`row`}>
                  <label className={`col-7 text-start`}>
                    Capacidad Equipaje(*)
                  </label>
                  <input
                    className={`col-4 inpObs`}
              ...
              <div className={`col-12 mt-2`}>
                <div className={`row`}>
                  <label className={`col-4 text-start mt-1`}>
                  ...
                  <form
                    className={`${classes.container} ${Style.inputFecha} col-4`}
                    noValidate
                  >
                    <TextField
                      id="date"
              ...
              <div className={`col-12 mt-2`}>
                <div className={`row`}>
                  <label className={`col-4 text-start`}>
                    Líneas de negocio (*)
                  </label>
              ...
              <div className={`col-12 mt-2`}>
                <div className={`row`}>
                  <label className={`${Style.titleDoc} col-3 text-start mt-3`}>
                    Documentos (*)
                  </label>
              ...
              <div className={`col-12 mt-4`}>
                <div className={`row`}>
                  <label className={`${Style.titleVeh} col-3 text-center mt-2`}>
                    Fotos Vehículo (*)
                  </label>
                  <div className={`${Style.docs} col-8`}>
                    <div className={`${Style.docsDivs}`}>
          ...
          <div className={`col-12 mt-4`}>
            <div className={`${Style.buttons} row justify-content-center`}>
              <Link
                to="/back_office_administracion/vehiculos"
              ...
              <a
                className={`${Style.third} col-3`}
                href=""
                onClick={(e) => clear(e)}
              >
                <AiOutlineClear className={`${Style.iconClear}`} />
                Limpiar
              </a>
            </div>
          </div>
